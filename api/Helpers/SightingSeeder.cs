...
//     {
//     var context = serviceProvider.GetRequiredService<ClassroomHelperDbContext>();
//     var userManager = serviceProvider.GetRequiredService<UserManager<ClassroomHelperUser>>();
//         var userEmail = "whalefan@ocean.com";
//         var userPassword = "IloveWhales2!";
//         var user = await userManager.FindByEmailAsync(userEmail);
//         if (user == null)
//         {
//             var newUser = new ClassroomHelperUser
//             {
//                 UserName = "WhaleFan",
//                 Email = userEmail,
//                 EmailConfirmed = true
